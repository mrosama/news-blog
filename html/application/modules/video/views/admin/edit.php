...
'type'              : 'iframe'
  ...
  <nav class="uk-navbar navtitle" >
    <ul class="uk-navbar-nav tm-navbar navtitle"  >
        <li class="navtitle"  ><a href="<?php echo base_url('video/admin/index'); ?>"> <?php echo $this -> lang -> line('video_edit'); ?> <i class="uk-icon-video-camera"></i></a></li>
...
<div class="uk-grid">
 ...
 if($video_info['pic']!=""){
 ?>
 <img src="<?php echo base_url($video_info['pic']);?>"  width="70" height="60" style="border:1px #666666 solid"/>
 <?php
 }
 ...
 ?>    
      ...
      <div class="uk-form-row">
         ...
         <div class="uk-form-controls">
          <input class="uk-form-width-large font_deafult" value="<?php echo $video_info['filename'];?>" type="text" name="field_one" id="field_one" placeholder="" >
...
title="Upload link" >
 ...
 <label class="uk-form-label" for="youtube"  ><?php echo $this->lang->line('video_youtube');?></label>
  <div class="uk-form-controls">
               ...
               <?php
 if($video_info['pic_youtube']!=""){
 ?>
 <img src="<?php echo $video_info['pic_youtube'];?>"  width="70" height="60" style="border:1px #666666 solid"/>
 <?php
 }
 
 ?> 
      
 <textarea id="youtube" name="youtube" cols="70" rows="4" placeholder=""><?php echo $video_info['youtube']?></textarea>
 <br/>
     ...
     <!-- -->  
      ...
      <div class="uk-form-row">
         ...
         <div class="uk-form-controls">
          <input class="uk-form-width-large font_deafult" type="text" name="title" id="title" placeholder="" value="<?php echo $video_info['title']?>" />
             </div>
            </div>
 ...
 // if($TPL_Config != 'A' && $TPL_Config!='B'){
  ?>     
         ...
         <div class="uk-form-controls">
          <input class="uk-form-width-large font_deafult" type="text" name="title_en" id="title_en" placeholder="" value="<?php echo $video_info['title_en']?>" />
             </div>
            </div>
           <?php
            }
 ...
 <label class="uk-form-label" for="content" ><?php echo $this->lang->line('video_content');?></label>
  <div class="uk-form-controls">
 <textarea id="content" name="content" cols="70" rows="4" placeholder=""><?php echo $video_info['content']?></textarea>
  </div>
 </div>
 ...
 <label class="uk-form-label" for="content_en" ><?php echo $this->lang->line('video_content_en');?></label>
  <div class="uk-form-controls">
 <textarea id="content_en" name="content_en" cols="70" rows="4" placeholder=""><?php echo $video_info['content_en']?> </textarea>
  </div>
 </div>   
 <?php
 }
 ?>      
      ...
      <div class="uk-form-row">
         ...
         <div class="uk-form-controls">
          <input class="uk-form-width-mediam font_deafult" type="text" name="author" id="author" value="<?php echo $video_info['author']?>" />
             </div>
            </div>             
 ...
 <button  class="uk-button uk-button-success uk-width-1-4 font_deafult"
   type="button" onclick="window.location.href='<?php echo base_url('video/admin/index');?>';"   data-uk-button><?php echo $this->lang->line('masmail_msg_back');?>     </button>
    ...
    <input type="hidden" name="id" value="<?php echo $video_info['ID']?>">
    
    
        <input type="hidden" value="<?php echo $video_info['pic'];?>" name="pic" />
            <input type="hidden" value="<?php echo $video_info['pic_youtube'];?>" name="pic_youtube" />
