...
<link rel="stylesheet" type="text/css" href="<?php echo base_url('assets/lib/breadcrumb/css/global.css');?>" />
    ...
    <div id="breadcrumb2">
            <ul class="crumbs2">
                ...
                <li class="first"><a  class="mytext" href="<?php echo base_url('app/info');?>"><?php echo $this->lang->line('app_theway');?></a></li>
...
<?php
  echo modules::run('post/page',17);

?>

<script type="text/javascript">
    $(document).ready(function() {
        $(this).attr("title", "<?php echo $this->lang->line('app_theway');?>");
    });
</script>