...
<link rel="stylesheet" type="text/css" href="<?php echo base_url('assets/lib/breadcrumb/css/global.css');?>" />
    ...
    <div id="breadcrumb2">
            <ul class="crumbs2">
                ...
                <li class="first"><a  class="mytext" href="<?php echo base_url('app/register');?>"><?php echo $this->lang->line('app_newmemeber');?></a></li>
...
<?php
echo modules::run('api/register','ds5&f46#d5s@f4@#0od$0w3fdgdf',base_url('app/reg'));
