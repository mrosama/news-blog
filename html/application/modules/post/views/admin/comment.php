...
?>
  ...
  <nav class="uk-navbar navtitle" >
    <ul class="uk-navbar-nav tm-navbar navtitle"  >
        <li class="navtitle"  ><a href="<?php echo base_url('post/admin/index'); ?>"> <?php echo $this -> lang -> line('posts_comments'); ?> <i class="uk-icon-comment"></i></a></li>
...
<table class="uk-table uk-table-hover uk-table-striped uk-table-condensed uk-text-center">
   <!-- -->  
              ...
              <tr class="classTableHeader font_deafult">
                 ...
                 <th class="uk-text-center"><?php echo $this -> lang -> line('posts_comment_name'); ?></th>
                  <th class="uk-text-center"><?php echo $this -> lang -> line('posts_comment_email'); ?></th>
                  <th class="uk-text-center"><?php echo $this -> lang -> line('posts_comment_content'); ?></th>
                  <th class="uk-text-center"><?php echo $this -> lang -> line('posts_date'); ?></th>
          
          <th class="uk-text-center"><?php echo $this -> lang -> line('posts_comment_status'); ?></th>
...
<div id="my-ads<?php echo $V_record['ID'];?>" class="uk-modal" style="direction: ltr;text-align: left;">
    <div class="uk-modal-dialog" uk-text-primary>
     ...
     if($V_record['active']=='YES'){
       ...
       <img src="<?php echo $base?>/img/jv7f81.gif" alt="<?php echo $this->lang->line('posts_comment_enable');?>">
       <?php  
         
     } else {
         ?>
          <img src="<?php echo $base?>/img/gydsvt.gif" alt="<?php echo $this->lang->line('posts_comment_disabled');?>">
         <?php
     }
     ?>
          </div>
...
<button  class="uk-button uk-button-danger uk-width-1-4 font_deafult"
   type="submit" name="IsPost_delmembers" value="y"  data-uk-button><?php echo $this->lang->line('posts_delete');?></button>
   

<button  class="uk-button uk-button-success uk-width-1-4 font_deafult"
   type="submit" name="IsPost_activemembers" value="y"  data-uk-button><?php echo $this->lang->line('posts_comment_active');?></button>
     
     
     
 <button  class="uk-button uk-button-primary uk-width-1-4 font_deafult"
   type="submit" name="IsPost_deactivemembers" value="y"  data-uk-button><?php echo $this->lang->line('posts_comment_deactive');?></button>
