...
function findinArray(val){
  ...
  <nav class="uk-navbar navtitle" >
    <ul class="uk-navbar-nav tm-navbar navtitle"  >
        <li class="navtitle"  ><a href="<?php echo base_url('post/admin/index'); ?>">   <?php echo $this -> lang -> line('posts_edit'); ?> <i class="uk-icon-laptop"></i></a></li>
     ...
     <!-- -->  
      ...
      <div class="uk-form-row">
         ...
         <div class="uk-form-controls">
          <input class="uk-form-width-large font_deafult" type="text" name="field_one" id="field_one"  value="<?php echo $row_post['pic'];?>" placeholder="" >
...
<input type="hidden" name="field_two" id="field_two" value="<?php echo $row_post['pic_small'];?>"  />

        <div class="uk-form-row">
         <label class="uk-form-label" for="title_pic"> <?php echo $this->lang->line('posts_picstitle');?> </label>
         <div class="uk-form-controls">
          <input class="uk-form-width-large font_deafult" type="text" value="<?php echo $row_post['title_pic'];?>" name="title_pic" id="title_pic" placeholder="" >
             </div>
            </div>
      ...
      <div class="uk-form-row">
         ...
         <div class="uk-form-controls">
          <input class="uk-form-width-mediam font_deafult" type="text" name="author" id="author"  value="<?php echo $row_post['author'];?>" >
             </div>
            </div>             
  ...
  <div id="toptags" style="display: none;max-width:450px;word-wrap:break-word;">
     ...
     <!-- -->  
      ...
      <div class="uk-form-row">
         ...
         <div class="uk-form-controls">
          <input class="uk-form-width-large font_deafult" type="text" name="title" id="title" placeholder=""  value="<?php echo $row_post['title'];?>" >
             </div>
            </div>
 ...
 // if($TPL_Config != 'A' && $TPL_Config!='B'){
  ?>     
         ...
         <div class="uk-form-controls">
          <input class="uk-form-width-large font_deafult" type="text" name="title_en" id="title_en" placeholder=""  value="<?php echo $row_post['title_en'];?>" >
             </div>
            </div>
           <?php
            }
 ...
 <label class="uk-form-label" for="content" ><?php echo $this->lang->line('posts_content');?></label>
  <div class="uk-form-controls">
 <textarea class="_editor" id="content" name="content" cols="70" rows="4" placeholder=""><?php echo $row_post['content'];?></textarea>
  </div>
 ...
 <label class="uk-form-label" for="content_en" ><?php echo $this->lang->line('posts_content_en');?></label>
  <div class="uk-form-controls">
 <textarea id="content_en" class="_editor" name="content_en" cols="70" rows="4" placeholder=""><?php echo $row_post['content_en'];?></textarea>
  </div>
  <span class="uk-text-danger"><small><?php echo $this->lang->line('posts_fullscreen');?></small></span>
 </div>   
 <?php
 ...
 ?>      
  ...
  <button  class="uk-button uk-button-success uk-width-1-4 font_deafult"
   type="button" onclick="window.location.href='<?php echo base_url('post/admin/index');?>';"   data-uk-button><?php echo $this->lang->line('posts_back');?>     </button>
    ...
    <input type="hidden" name="id" value="<?php echo $row_post['ID'];?>" id="id">
 </form></div></div></div>   
...
if(is_array($etags)){
    foreach($etags as  $vtag){
        ?>
        <script>
        addTag2('<?php echo $vtag['tag'];?>');
        </script>
        <?php
    }
